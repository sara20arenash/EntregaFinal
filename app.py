...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://upload.wikimedia.org/wikipedia/commons/f/fe/F1-Bandera_negra.png");
...
if est2 == 'All crimes' : 
    ...
    g1.update_layout(
        title = 'Numero de crimenes por estado',
        xaxis_title = 'Estados',
    ...
    # agregar detalles a la gráfica
    g2.update_layout(
        title='Estados con mas registros de crímenes de propiedad que se cometieron',
        xaxis_title = 'Estados',
        yaxis_title = 'Cantidad de registros',
        template = 'simple_white',
        paper_bgcolor='rgba(0,0,0,0)',
    ...
    # agregar detalles a la gráfica
    g3.update_layout(
        title='Estados con mas registros de crimenes violentos',
        xaxis_title = 'Estados',
        yaxis_title = 'Cantidad de registros',
        template = 'simple_white',
        paper_bgcolor='rgba(0,0,0,0)',
    ...
    # agregar detalles a la gráfica
    g4.update_layout(
        title='Estados con mas registros de homicidios',
        xaxis_title = 'Estados',
        yaxis_title = 'Cantidad de registros',
        template = 'simple_white',
        paper_bgcolor='rgba(0,0,0,0)',
    ...
    # agregar detalles a la gráfica
    g5.update_layout(
        title='Estados con mas registros de violaciones al legado',
        xaxis_title = 'Estados',
        yaxis_title = 'Cantidad de registros',
        template = 'simple_white',
        paper_bgcolor='rgba(0,0,0,0)',
    ...
    # agregar detalles a la gráfica
    g5.update_layout(
        title='Estados con mas registros de violaciones sexuales',
        xaxis_title = 'Estados',
        yaxis_title = 'Cantidad de registros',
        template = 'simple_white',
        paper_bgcolor='rgba(0,0,0,0)',
    ...
    # agregar detalles a la gráfica
    g5.update_layout(
        title='Estados con mas registros de robos',
        xaxis_title = 'Estados',
        yaxis_title = 'Cantidad de registros',
        template = 'simple_white',
        paper_bgcolor='rgba(0,0,0,0)',
    ...
    # agregar detalles a la gráfica
    g5.update_layout(
        title='Estados con mas registros de asaltos agravados',
        xaxis_title = 'Estados',
        yaxis_title = 'Cantidad de registros',
        template = 'simple_white',
        paper_bgcolor='rgba(0,0,0,0)',
    ...
    st.plotly_chart(g5)
     ...
     # agregar detalles a la gráfica
     g5.update_layout(
         title='Estados con mas registros de robos en ausencia de la victima',
         xaxis_title = 'Estados',
         yaxis_title = 'Cantidad de registros',
         template = 'simple_white',
         paper_bgcolor='rgba(0,0,0,0)',
     ...
     # agregar detalles a la gráfica
     g5.update_layout(
         title='Estados con mas registros de robos sin violencia',
         xaxis_title = 'Estados',
         yaxis_title = 'Cantidad de registros',
         template = 'simple_white',
         paper_bgcolor='rgba(0,0,0,0)',
     ...
     # agregar detalles a la gráfica
     g5.update_layout(
         title='Estados con mas registros de robos de vehiculos motorizados',
         xaxis_title = 'Estados',
         yaxis_title = 'Cantidad de registros',
         template = 'simple_white',
         paper_bgcolor='rgba(0,0,0,0)',
